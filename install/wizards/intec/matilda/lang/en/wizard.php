...
$MESS['wizard.steps.begin.description'] = 'Добро пожаловать в мастер установки лендинга';
...
$MESS['wizard.steps.locations.title'] = 'Местоположения';
...
$MESS['wizard.locations.ussr'] = 'Россия и СНГ (страны и города)';
$MESS['wizard.locations.ua'] = 'Украина';
$MESS['wizard.locations.kz'] = 'Казахстан';
$MESS['wizard.locations.usa'] = 'США (города)';
$MESS['wizard.locations.country'] = 'Мир (страны)';
$MESS['wizard.locations.none'] = 'Не загружать';

$MESS['wizard.fields.errors.empty'] = 'Поле "#NAME#" не должно быть пустым';
$MESS['wizard.fields.siteName'] = 'Название сайта';
$MESS['wizard.fields.siteName.value'] = 'MaTilda';
...
$MESS['wizard.fields.siteMetaKeywords.value'] = 'Лендинг';
